      ...
      {(isAdding || editingRoom) && (
        <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              <label htmlFor="gioi_tinh" className="text-sm font-medium text-gray-700 capitalize mb-1">Giới Tính Phòng</label>
              <select
                id="gioi_tinh"
                name="gioi_tinh"
            ...
            <div className="flex flex-col">
              <label htmlFor="hinh_anh" className="text-sm font-medium text-gray-700 capitalize mb-1">Ảnh Phòng</label>
              <input
                type="text"
                id="hinh_anh"
                name="hinh_anh"
            ...
            <div className="flex flex-col col-span-full">
              <label htmlFor="ghi_chu" className="text-sm font-medium text-gray-700 capitalize mb-1">Mô Tả</label>
              <textarea
                id="ghi_chu"
                name="ghi_chu"
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredRooms.map((room) => (
                  <tr key={room.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{room.gioi_tinh}</td>
